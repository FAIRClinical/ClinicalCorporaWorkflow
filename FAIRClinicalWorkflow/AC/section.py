...
class Section:
    ...
    def __get_references(self, soup_section: object):
        """
        Retrieve references from the soup object
        Args:
            soup_section: object: soup object containing a section of text
        """
    ...
    def __init__(self, config, section_dict):
        ...
        self.config = config
        self.section_heading = section_dict['headers'][0] if "headers" in section_dict \
                                                             and not section_dict['headers'] == "" else ""
        self.__set_iao()
        self.subheader = ""
        self.paragraphs = []
